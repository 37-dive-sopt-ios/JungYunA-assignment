...
final class DiscountStoreCell : UICollectionViewCell {
    
    static let identifier: String = "DiscountStoreCell"
    ...
    func configure(with store: DiscountStore) {
